...
const MAJOR_CITIES = [
  ...
  '수원', '고양', '용인', '창원', '성남', '화성', '부천',
  '남양주', '안산', '안양', '평택', '시흥', '파주',
  '김해', '천안', '전주', '청주', '포항'
];

const normalizeRegionToRoom = (regionName: string): string => {
  const n = regionName;
  ...
  if (n.includes('충북') || n.includes('충주') || n.includes('제천') ||
      ...
      n.includes('음성') || n.includes('단양')) return '충청북도';
  ...
  if (n.includes('충남') || n.includes('공주') || n.includes('보령') ||
      ...
      n.includes('홍성') || n.includes('예산') || n.includes('태안')) return '충청남도';
  ...
  if (n.includes('전북') || n.includes('군산') || n.includes('익산') ||
      ...
      n.includes('고창') || n.includes('부안')) return '전라북도';
  ...
  if (n.includes('경북') || n.includes('경주') || n.includes('김천') ||
      ...
      n.includes('울진') || n.includes('울릉')) return '경상북도';
  ...
  if (n.includes('경남') || n.includes('진주') || n.includes('통영') ||
      ...
      n.includes('창녕') || n.includes('남해') || n.includes('하동') ||
      n.includes('산청') || n.includes('함양') || n.includes('거창') ||
      n.includes('합천')) return '경상남도';
